...
public abstract class CameraController {
	...
	public static class CameraFeatures {
		...
		public boolean supports_apertures;
		public List<Float> apertures;
	...
	public static class Photo {
		// Compressed JPEG
		public Image jpegImage;
		public byte [] jpeg;

		// Uncompressed YUV image
		public Image yuvImage;
		public int width;
		public int height;
		public byte [] y;
		public byte [] u;
		...
		public boolean hasJpeg() {
			return jpegImage != null || jpeg != null;
		}

		public boolean hasYuv() {
			return yuvImage != null || y != null;
		}
		...
		public void setJpegFromImage(Image image) {
			ByteBuffer buffer = image.getPlanes()[0].getBuffer();
			jpeg = new byte[buffer.remaining()];
			if( MyDebug.LOG )
				Log.d(TAG, "read " + jpeg.length + " bytes");
			buffer.get(jpeg);
		}

		public void setYuvFromImage(Image image) {
		...
		public void getDataFromImages() {
			if (jpegImage != null) {
				setJpegFromImage(jpegImage);
				jpegImage.close();
				jpegImage = null;
			}
			if (yuvImage != null) {
				setYuvFromImage(yuvImage);
				yuvImage.close();
				yuvImage = null;
			}
		}
	...
	public boolean setWhiteBalanceRGB(float r, float g, float b) {return false;};
	 ...
	 */
	public void setManualISO(boolean manual_iso, int iso, boolean less_or_equal) {};
	...
	public boolean setAperture(float value) {return false;}
	public float getAperture() {return 0.0f;}
	...
	public abstract void setExpoBracketingStack(double stops_up, int images_up, double stops_down, int images_down);
	 ...
	 */
	public enum FakeFlashMode {
		None,
		Torch,
		Flash
	}
	public void setFakeFlashMode(FakeFlashMode fake_flash_mode) {}
	public FakeFlashMode getFakeFlashMode() {return FakeFlashMode.None;}
	...
	public void setToneMappingGamma(float gamma) {};
	public void setToneMappingCurve(float[] levelsR, float[] levelsG, float[] levelsB) {};
	public boolean hasToneMapping() {return false;};
	...
	public abstract boolean setFocusAndMeteringArea(List<CameraController.Area> areas, boolean focus_area, boolean metering_area);
	...
	public long getApproximatelyTotalExposureTime() {return 100L;}
