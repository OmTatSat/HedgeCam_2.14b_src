...
public class Prefs {
	...
	public static final boolean test_exifinterface_dng = false;
	...
	public static final String DONE_AUTO_LEVEL_INFO = "done_auto_level_info";
	...
	public static final String WHITE_BALANCE_R = "preference_white_balance_r";
	public static final String WHITE_BALANCE_G = "preference_white_balance_g";
	public static final String WHITE_BALANCE_B = "preference_white_balance_b";
	...
	public static final String ISO_MIN = "preference_iso_min";
	public static final String ISO_MAX = "preference_iso_max";
	public static final String EXPOSURE_TIME_MIN = "preference_exposure_time_min";
	public static final String EXPOSURE_TIME_MAX = "preference_exposure_time_max";
	public static final String APERTURE = "preference_aperture";	
	public static final String IMAGE_FORMAT = "preference_image_format";
	public static final String RAW = "preference_raw";
	public static final String RAW_LENS_SHADING = "preference_raw_lens_shading";
	public static final String RAW_THUMBNAIL = "preference_raw_thumbnail";
	public static final String CUSTOM_DNG_CREATOR = "preference_custom_dng_creator";
	public static final String DNG_CROP_LEFT = "preference_dng_crop_left";
	public static final String DNG_CROP_TOP = "preference_dng_crop_top";
	public static final String DNG_CROP_RIGHT = "preference_dng_crop_right";
	public static final String DNG_CROP_BOTTOM = "preference_dng_crop_bottom";
	public static final String DNG_NOISE_PROFILE = "preference_dng_noise_profile";
	public static final String DNG_EXPOSURE_CORRECTION = "preference_dng_exposure_correction";
	public static final String DNG_BAD_PIXELS = "preference_dng_bad_pixels";
	public static final String DNG_CUSTOM_BAD_PIXELS = "preference_dng_custom_bad_pixels";
	public static final String DNG_CUSTOM_BAD_PIXELS_FILE = "preference_dng_custom_bad_pixels_file";
	public static final String DNG_CUSTOM_BAD_PIXELS_LE = "preference_dng_custom_bad_pixels_le";
	public static final String DNG_CUSTOM_BAD_PIXELS_LE_FILE = "preference_dng_custom_bad_pixels_le_file";
	public static final String DNG_PACK_BITS = "preference_dng_pack_bits";
	public static final String TONE_MAPPING = "preference_tone_mapping";
	public static final String TONE_MAPPING_FILE = "preference_tone_mapping_file";
	public static final String EXPO_BRACKETING_UP = "preference_expo_bracketing_up";
	public static final String EXPO_BRACKETING_DOWN = "preference_expo_bracketing_down";
	...
	public static final String AUTO_LEVEL = "preference_auto_level";
	public static final String AUTO_LEVEL_MODE = "preference_auto_level_mode";
	public static final String AUTO_LEVEL_FIXED_SIZE = "preference_auto_level_fixed_size";
	public static final String AUTO_LEVEL_RATIO = "preference_auto_level_ratio";
	...
	public static final String GPS_ALTITUDE = "preference_gps_altitude";
	public static final String GPS_ALTITUDE_CORRECTION = "preference_gps_altitude_correction";
	public static final String GPS_SPEED = "preference_gps_speed";
	...
	public static final String CAMERA2_FAKE_FLASH = "preference_fake_flash";
	public static final String RESET_FLASH = "preference_reset_flash";
	...
	public static final String SHOW_MEMORY_USAGE = "preference_show_memory_usage";
	...
	public static final String SEPARATE_LEVEL_CALIBRATION = "preference_separate_level_calibration";
	public static final String CALIBRATED_LEVEL_ANGLE_P = "preference_calibrated_level_angle_p";
	public static final String CALIBRATED_LEVEL_ANGLE_RL = "preference_calibrated_level_angle_rl";
	public static final String CALIBRATED_LEVEL_ANGLE_RP = "preference_calibrated_level_angle_rp";
	...
	public static final String GRID_COLOR = "preference_grid_color";
	public static final String CROP_BORDER = "preference_crop_border";
	public static final String CROP_GUIDE = "preference_crop_guide";
	public static final String CROP_GUIDE_COLOR = "preference_crop_guide_color";
	public static final String DARKEN_OUTSIDE_BORDER = "preference_darken_outside_border";
	...
	public static final String TONE_MAPPING_VIDEO = "preference_tone_mapping_video";
	public static final String TONE_MAPPING_VIDEO_FILE = "preference_tone_mapping_video_file";
	...
	public static final String SWITCH_CAMERA_BUTTON = "preference_switch_camera_button";
	...
	public static final String SATURATION = "preference_saturation";
	public static final String SATURATION_R = "preference_saturation_r";
	public static final String SATURATION_G = "preference_saturation_g";
	public static final String SATURATION_B = "preference_saturation_b";

	public static final String DRO_SAVE_BASE = "preference_dro_save_base";
	...
	public static final String PREVIEW_AUTO_IN_MANUAL_MODE = "preference_preview_auto_in_manual_mode";
	...
	public static final String CTRL_PANEL_LOCK_WB = "preference_ctrl_panel_lock_wb";
	...
	public static final String CTRL_PANEL_IMMERSIVE_MODE = "preference_ctrl_panel_immersive_mode";
	...
	public static final String MODE_PANEL_LOCK_WB = "preference_mode_panel_lock_wb";
	...
	public static final String MODE_PANEL_IMMERSIVE_MODE = "preference_mode_panel_immersive_mode";
	...
	public static final String PREVIEW_TAP = "preference_preview_tap";
	public static final String ORIENTATION_SENSOR = "preference_orientation_sensor";
	public static final String ORIENTATION_SENSOR_DELAY = "preference_orientation_sensor_delay";
	public static final String GEOMAGNETIC_SENSOR_DELAY = "preference_geomagnetic_sensor_delay";
	...
	public static final String POPUP_CAMERA = "preference_popup_camera";
	public static final String POPUP_ISO = "preference_popup_iso";
	public static final String POPUP_ISO_FIXED = "preference_popup_iso_fixed";
	public static final String POPUP_ISO_MAX = "preference_popup_iso_max";
	public static final String POPUP_PHOTO_MODE = "preference_popup_photo_mode";
	public static final String POPUP_APERTURE = "preference_popup_aperture";
	...
	public static final String POPUP_STAMP = "preference_popup_stamp";
	public static final String POPUP_AUTO_LEVEL = "preference_popup_auto_level";
	...
	public static final String POPUP_RAW = "preference_popup_raw";
	...
	public static final String POPUP_TONE_MAPPING = "preference_popup_video_log";
	...
	public static final String FORCE_MANUAL_WB = "preference_force_manual_wb";
	...
	public static final String FILTERING_CAPTURE_ONLY = "preference_filtering_capture_only";
	...
	public static final String SAVE_EXIF = "preference_save_exif";
	...
	public static final String RESET_MANUAL_WB = "preference_reset_manual_wb";
	public static final String RESET_MANUAL_FOCUS = "preference_reset_manual_focus";
	public static final String SCENES_CONTINUOUS_FOCUS = "preference_scenes_continuous_focus";
	...
	public static final String IMAGE_READER_CAPACITY = "preference_image_reader_capacity";
	public static final String IMAGE_READER_MAX_CAPACITY = "preference_image_reader_max_capacity";
	public static final String ALT_IMAGE_HOLDER = "preference_alt_image_holder";
	...
	public static Category[] PREF_CATEGORIES = {
		...
		new Category("model", R.string.preference_category_model, R.string.preference_category_model_summary, new String[] {
			...
			GEOMAGNETIC_SENSOR_DELAY,
			FULL_SIZE_COPY,
			RESET_MANUAL_MODE,
			LOCK_PREVIEW_FPS_TO_VIDEO_FPS,
			DEFAULT_COLOR_CORRECTION,
			FORCE_ISO_EXPOSURE,
			FORCE_ISO_EXPOSURE+"_video",
			FORCE_MANUAL_WB,
			FORCE_MANUAL_WB+"_video",
			...
			ISO_MAX+"_2",
			ISO_MAX+"_3",
			EXPOSURE_TIME_MIN+"_0",
			EXPOSURE_TIME_MIN+"_1",
			EXPOSURE_TIME_MIN+"_2",
			EXPOSURE_TIME_MIN+"_3",
			EXPOSURE_TIME_MAX+"_0",
			EXPOSURE_TIME_MAX+"_1",
			EXPOSURE_TIME_MAX+"_2",
			EXPOSURE_TIME_MAX+"_3",
		}),
		...
		new Category("filtering", R.string.preference_screen_filtering, 0, new String[] {
			...
			OPTICAL_STABILIZATION+"_3",
			HOT_PIXEL_CORRECTION+"_2_0",
			HOT_PIXEL_CORRECTION+"_2_1",
			HOT_PIXEL_CORRECTION+"_2_2",
			HOT_PIXEL_CORRECTION+"_2_3"
		}),
		new Category("raw", R.string.preference_raw, 0, new String[] {
			RAW,
			RAW_LENS_SHADING,
			RAW_THUMBNAIL,
			CUSTOM_DNG_CREATOR,
			...
			DNG_CROP_BOTTOM+"_2",
			DNG_CROP_BOTTOM+"_3",
			DNG_NOISE_PROFILE+"_0",
			DNG_NOISE_PROFILE+"_1",
			DNG_NOISE_PROFILE+"_2",
			DNG_NOISE_PROFILE+"_3",
			DNG_EXPOSURE_CORRECTION+"_0",
			DNG_EXPOSURE_CORRECTION+"_1",
			DNG_EXPOSURE_CORRECTION+"_2",
			DNG_EXPOSURE_CORRECTION+"_3",
			DNG_BAD_PIXELS+"_0",
			DNG_BAD_PIXELS+"_1",
			DNG_BAD_PIXELS+"_2",
			DNG_BAD_PIXELS+"_3",
			DNG_CUSTOM_BAD_PIXELS+"_0",
			DNG_CUSTOM_BAD_PIXELS+"_1",
			DNG_CUSTOM_BAD_PIXELS+"_2",
			DNG_CUSTOM_BAD_PIXELS+"_3",
			DNG_CUSTOM_BAD_PIXELS_FILE+"_0",
			DNG_CUSTOM_BAD_PIXELS_FILE+"_1",
			DNG_CUSTOM_BAD_PIXELS_FILE+"_2",
			DNG_CUSTOM_BAD_PIXELS_FILE+"_3",
			DNG_CUSTOM_BAD_PIXELS_LE+"_0",
			DNG_CUSTOM_BAD_PIXELS_LE+"_1",
			DNG_CUSTOM_BAD_PIXELS_LE+"_2",
			DNG_CUSTOM_BAD_PIXELS_LE+"_3",
			DNG_CUSTOM_BAD_PIXELS_LE_FILE+"_0",
			DNG_CUSTOM_BAD_PIXELS_LE_FILE+"_1",
			DNG_CUSTOM_BAD_PIXELS_LE_FILE+"_2",
			DNG_CUSTOM_BAD_PIXELS_LE_FILE+"_3",
			DNG_PACK_BITS
		})
	};
	...
	public static String getFlashPref() {
		return sharedPreferences.getString(getFlashPreferenceKey(), "flash_off");
	}
	...
	public static void clearFocusPref() {
		SharedPreferences.Editor editor = sharedPreferences.edit();
		editor.remove(getFocusPreferenceKey());
		editor.apply();
	}
	...
	public static boolean getAutoLevelPref() {
		if( main_activity.supportsAutoLevel() && sharedPreferences.getBoolean(AUTO_LEVEL, false))
			return true;
		return false;
	}
	...
	public static int decodeSensorDelayValue(String value) {
		switch (value) {
			case "ui":
	...
	public static Float getFloatOrNull(final String prefKey, final String defaultValue) {
		String stringValue = sharedPreferences.getString(prefKey, defaultValue);
	...
	public static double getStringAsDouble(final String prefKey, final double defaultValue) {
		double value = defaultValue;
		try {
			value = Double.parseDouble(sharedPreferences.getString(prefKey, Double.toString(defaultValue)));
		} catch(NumberFormatException e) {}
		return value;
	}
